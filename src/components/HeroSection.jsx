      ...
      <div className="container z-10 max-w-6xl mx-auto">
        ...
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            Hi, I’m Abhijeet — a dedicated Full-Stack Developer who enjoys building dynamic, efficient, and user-focused web applications. With hands-on experience in React, Node.js, and other modern technologies, I love bringing ideas to life through clean and functional code.
              <br />
              <br />
              I’m always exploring new tools and frameworks to strengthen my skills and stay updated with modern development trends
              <br />
              <br />
